...
python () {
    if d.getVar("KERNEL_PACKAGE_NAME") == "kernel" and d.getVar("PREFERRED_PROVIDER_virtual/kernel") != "linux-yocto-dev-rt":
        raise bb.parse.SkipRecipe("Set PREFERRED_PROVIDER_virtual/kernel to linux-yocto-dev-rt to enable it")
}

KBRANCH = "v6.13/standard/preempt-rt/base"
KMETA = "kernel-meta"
...
SRCREV_machine ?= '${@oe.utils.conditional("PREFERRED_PROVIDER_virtual/kernel", "linux-yocto-dev-rt", "${AUTOREV}", "7031a148aa7ae6a13cf64b52042c470158144d84", d)}'
SRCREV_meta ?= '${@oe.utils.conditional("PREFERRED_PROVIDER_virtual/kernel", "linux-yocto-dev-rt", "${AUTOREV}", "7031a148aa7ae6a13cf64b52042c470158144d84", d)}'

LINUX_VERSION ?= "6.13"
LINUX_VERSION_EXTENSION ?= "-yoctodevrt-${LINUX_KERNEL_TYPE}"
